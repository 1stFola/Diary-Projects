...
public class ShoppingMallApp {
    ...
    public static String displayInvoice(){
        ...
        return String.format("%s%-10s%-10s%-10s%-10s", address, item, quantity, price, total);
    }
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < products.size(); i++){
            System.out.printf("%s%10d%10.0f%10.0f", products.get(i), quantities.get(i), prices.get(i), total.get(i));
            System.out.println();
        }
    }
    ...
    private static void salesClerk(Scanner input) {
        ...
        System.out.println("How many of the " + product + "(s) did the customer get?");
        int quantity = input.nextInt();
        quantities.add(quantity);

        System.out.println("What is the unit price of  the " + product + "(s)?");
